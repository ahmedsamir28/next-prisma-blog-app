...
const WebHostingPlan = () => {
  return (
    <div className='flex flex-col items-center justify-center w-3/4 rounded-lg p-4 border-2 mb-7 md:w-2/4 lg:w-1/4'>
        <h3 className='text-3xl font-bold text-black'>Premium</h3>
        <strong className='text-3xl font-bold text-gray-600 my-5'>
            $4.99/mo
        </strong>
        ...
        <div className='mt-6 '>
            <h5 className='text-2xl mb-1 font-semibold text-blue-600'>
                Top Features
            </h5>
